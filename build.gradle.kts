...
// Android SDK bootstrap for the `com.android.kotlin.multiplatform.library`
// plugin. local.properties is autogenerated (and gitignored); the Android
// KMP target exists so `compileAndroidMain` emits real JVM `.class` files
// for CodeQL's `kotlinc` LD_PRELOAD tracer to hook.
