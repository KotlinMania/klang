 ...
 */
fun BytePointer.index(i: Int): BytePointer = BytePointer(this.ptr + i)
 ...
 */
fun ShortPointer.index(i: Int): ShortPointer = ShortPointer(this.ptr + i * 2)
 ...
 */
fun IntPointer.index(i: Int): IntPointer = IntPointer(this.ptr + i * 4)
 ...
 */
fun LongPointer.index(i: Int): LongPointer = LongPointer(this.ptr + i * 8)
 ...
 */
fun FloatPointer.index(i: Int): FloatPointer = FloatPointer(this.ptr + i * 4)
 ...
 */
fun DoublePointer.index(i: Int): DoublePointer = DoublePointer(this.ptr + i * 8)
 ...
 */
fun ShortPointer.store(v: Short) =
    io.github.kotlinmania.klang.mem.GlobalHeap
        .sh(ptr, v)
 ...
 */
fun FloatPointer.store(v: Float) =
    io.github.kotlinmania.klang.mem.GlobalHeap
        .swf(ptr, v)
 ...
 */
fun DoublePointer.store(v: Double) =
    io.github.kotlinmania.klang.mem.GlobalHeap
        .sdf(ptr, v)
 ...
 */
fun mallocBytes(n: Int): BytePointer =
    BytePointer(
        io.github.kotlinmania.klang.mem.GlobalHeap
            .malloc(n),
    )
 ...
 * @return A pointer to the allocated memory, or null on failure.
 */
fun callocBytes(n: Int): BytePointer =
    BytePointer(
        io.github.kotlinmania.klang.mem.GlobalHeap
            .calloc(n, 1),
    )
