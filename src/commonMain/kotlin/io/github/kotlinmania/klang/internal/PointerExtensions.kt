 ...
 */
fun CPointer<Byte>.load(): Byte = io.github.kotlinmania.klang.mem.GlobalHeap.lb(ptr)
 ...
 */
fun CPointer<Byte>.store(v: Byte) = io.github.kotlinmania.klang.mem.GlobalHeap.sb(ptr, v)
 ...
 */
fun CPointer<Short>.load(): Short = io.github.kotlinmania.klang.mem.GlobalHeap.lh(ptr)
 ...
 */
fun CPointer<Short>.store(v: Short) = io.github.kotlinmania.klang.mem.GlobalHeap.sh(ptr, v)
 ...
 */
fun CPointer<Int>.load(): Int = io.github.kotlinmania.klang.mem.GlobalHeap.lw(ptr)
 ...
 */
fun CPointer<Int>.store(v: Int) = io.github.kotlinmania.klang.mem.GlobalHeap.sw(ptr, v)
 ...
 */
fun CPointer<Long>.load(): Long = io.github.kotlinmania.klang.mem.GlobalHeap.ld(ptr)
 ...
 */
fun CPointer<Long>.store(v: Long) = io.github.kotlinmania.klang.mem.GlobalHeap.sd(ptr, v)
 ...
 */
fun CPointer<Float>.load(): Float = io.github.kotlinmania.klang.mem.GlobalHeap.lwf(ptr)
 ...
 */
fun CPointer<Float>.store(v: Float) = io.github.kotlinmania.klang.mem.GlobalHeap.swf(ptr, v)
 ...
 */
fun CPointer<Double>.load(): Double = io.github.kotlinmania.klang.mem.GlobalHeap.ldf(ptr)
 ...
 */
fun CPointer<Double>.store(v: Double) = io.github.kotlinmania.klang.mem.GlobalHeap.sdf(ptr, v)
 ...
 */
fun mallocBytes(n: Int): CPointer<Byte> = CPointer(io.github.kotlinmania.klang.mem.GlobalHeap.malloc(n))
 ...
 * @return A pointer to the allocated memory, or null on failure.
 */
fun callocBytes(n: Int): CPointer<Byte> = CPointer(io.github.kotlinmania.klang.mem.GlobalHeap.calloc(n, 1))
