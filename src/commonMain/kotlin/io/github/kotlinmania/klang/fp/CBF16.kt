 ...
 */
class CBF16 private constructor(
    private val bits: Short,
) {
    // --- basic access ---
        ...
        fun fromFloatBits(fBits: Int): CBF16 {
            ...
            if (exp == 0xFF) {
                if (frac == 0) {
                    ...
                    val out = (
                        (engine.unsignedRightShift(sign.toLong(), 16).value.toInt() and 0x8000) or
                ...
                var outBody = (
                    engine.leftShift(0xFF.toLong(), 7).value.toInt() or
