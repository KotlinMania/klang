...
- Arithmetic-based bit operations: For 8/16-bit worlds (e.g., Mark Adler’s zlib internals), we
  ...
  - `io.github.kotlinmania.klang.bitwise.ArithmeticBitwiseOps`
  - `io.github.kotlinmania.klang.bitwise.ArrayBitShifts`
  - `io.github.kotlinmania.klang.bitwise.BitwiseOps`
...
Notable Files
-------------
- Floating types: `io/github/kotlinmania/klang/fp/CFloat64.kt`, `io/github/kotlinmania/klang/fp/CLongDouble.kt`, `io/github/kotlinmania/klang/fp/CFloat128.kt`.
- Bitwise/limb: `io/github/kotlinmania/klang/bitwise/*`, `io/github/kotlinmania/klang/buffer/*`.
