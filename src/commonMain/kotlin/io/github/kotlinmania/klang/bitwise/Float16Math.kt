...
import io.github.kotlinmania.klang.fp.Float32Math
...
object Float16Math {
     ...
     */
    fun isZero(bits: Int): Boolean = (bits and 0x7FFF) == 0

    /**
     * Get sign of float16 value.
     * @return 1 for negative, 0 for positive
     */
    fun getSign(bits: Int): Int = (bits and SIGN_MASK) shr 15

    /**
     * Negate float16 value (flip sign bit).
     */
    fun negateBits(bits: Int): Int = (bits and 0xFFFF) xor SIGN_MASK

    /**
     * Absolute value (clear sign bit).
     */
    fun absBits(bits: Int): Int = bits and 0x7FFF
