...
class CFloat128Var(override val addr: Int) : CVar {
     ...
     */
    var value: io.github.kotlinmania.klang.fp.CFloat128
        get() {
...
class CLongDoubleVar(override val addr: Int) : CVar {
     ...
     */
    var value: io.github.kotlinmania.klang.fp.CLongDouble
        get() {
...
object CAutos {
     ...
     * @see io.github.kotlinmania.klang.fp.CFloat128
     */
    fun float128(init: io.github.kotlinmania.klang.fp.CFloat128 = io.github.kotlinmania.klang.fp.CFloat128.ZERO, align: Int = 16): CFloat128Var {
     ...
     * @see io.github.kotlinmania.klang.fp.CFloat16
     */
    fun float16(init: io.github.kotlinmania.klang.fp.CFloat16 = io.github.kotlinmania.klang.fp.CFloat16.Companion.ZERO, align: Int = 2): CFloat16Var {
        val p = KStack.alloca(2, align)
     ...
     * @see io.github.kotlinmania.klang.fp.CE8M0
     */
    fun e8m0(init: io.github.kotlinmania.klang.fp.CE8M0 = io.github.kotlinmania.klang.fp.CE8M0.ZERO, align: Int = 1): CE8M0Var {
        val p = KStack.alloca(1, align)
     ...
     * @see io.github.kotlinmania.klang.fp.CUE4M3
     */
    fun ue4m3(init: io.github.kotlinmania.klang.fp.CUE4M3 = io.github.kotlinmania.klang.fp.CUE4M3.ZERO, align: Int = 1): CUE4M3Var {
        val p = KStack.alloca(1, align)
        GlobalHeap.sb(p, init.toBits().toByte())
        return CUE4M3Var(p)
    }
...
object CGlobals {
     ...
     */
    fun float128(name: String, init: io.github.kotlinmania.klang.fp.CFloat128 = io.github.kotlinmania.klang.fp.CFloat128.ZERO, align: Int = 16): CFloat128Var {
     ...
     */
    fun float16(name: String, init: io.github.kotlinmania.klang.fp.CFloat16 = io.github.kotlinmania.klang.fp.CFloat16.Companion.ZERO, align: Int = 2): CFloat16Var {
     ...
     */
    fun e8m0(name: String, init: io.github.kotlinmania.klang.fp.CE8M0 = io.github.kotlinmania.klang.fp.CE8M0.ZERO, align: Int = 1): CE8M0Var {
     ...
     */
    fun ue4m3(name: String, init: io.github.kotlinmania.klang.fp.CUE4M3 = io.github.kotlinmania.klang.fp.CUE4M3.ZERO, align: Int = 1): CUE4M3Var {
        val addr = GlobalData.defineBss(name, 1, align)
        GlobalHeap.sb(addr, init.toBits().toByte())
