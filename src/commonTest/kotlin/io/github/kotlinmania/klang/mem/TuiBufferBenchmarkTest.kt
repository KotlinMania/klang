...
class TuiBufferBenchmarkTest {
    ...
    fun benchmarkDirectByteAccess() {
        ...
        println("BitShiftConfig.defaultMode = ${io.github.kotlinmania.klang.bitwise.BitShiftConfig.defaultMode}")
        println("Resolved mode for 8-bit: ${io.github.kotlinmania.klang.bitwise.BitShiftConfig.resolveMode(8)}")
        println("Resolved mode for 16-bit: ${io.github.kotlinmania.klang.bitwise.BitShiftConfig.resolveMode(16)}")
        println("Resolved mode for 32-bit: ${io.github.kotlinmania.klang.bitwise.BitShiftConfig.resolveMode(32)}")

        // Force NATIVE mode for fair comparison
        io.github.kotlinmania.klang.bitwise.BitShiftConfig.defaultMode = io.github.kotlinmania.klang.bitwise.BitShiftMode.NATIVE
